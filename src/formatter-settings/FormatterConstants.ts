...
export class ExampleManager {
  ...
  private static COMMENT_EXAMPLE = "/**\n" +
  ...
  public static getExample(example: ExampleKind): string {
    switch(example) {
      case ExampleKind.COMMON_EXAMPLE:
        return ExampleManager.COMMON_EXAMPLE;
      case ExampleKind.BLANKLINE_EXAMPLE:
        return ExampleManager.BLANKLINE_EXAMPLE;
      case ExampleKind.COMMENT_EXAMPLE:
        return ExampleManager.COMMENT_EXAMPLE;
      case ExampleKind.NEWLINE_EXAMPLE:
        return ExampleManager.NEWLINE_EXAMPLE;
      case ExampleKind.BRACED_CODE_EXAMPLE:
        return ExampleManager.BRACED_CODE_EXAMPLE;
      case ExampleKind.ANNOTATION_AND_ANONYMOUS_EXAMPLE:
        return ExampleManager.ANNOTATION_AND_ANONYMOUS_EXAMPLE;
      case ExampleKind.WHITESPACE_EXAMPLE:
        return ExampleManager.WHITESPACE_EXAMPLE;
      case ExampleKind.WRAPPING_EXAMPLE:
        return ExampleManager.WRAPPING_EXAMPLE;
      default:
        return "";
    }
  }
